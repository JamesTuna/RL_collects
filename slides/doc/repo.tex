...
\begin{frame}{Policy based method}
    ...
    \begin{center}\includegraphics[width=.6\textwidth]{mirrorState}\end{center}
    \begin{itemize}
...
\begin{frame}{Vanilla Policy Gradient: \textbf{REINFORCE}}
    \vspace{0.2cm}
    \begin{center}Experiment on CartPole game:\\Bad performance, even not converge after 1000 episodes of training\\\includegraphics[width=.7\textwidth]{REINFORCE1}\end{center}
\end{frame}
...
\begin{frame}{Improvement for \textbf{REINFORCE}: advantage function}
    \vspace{0.2cm}
    \begin{center}Experiment on CartPole game:\\Only after 141 episodes of training, surviving time boosted to 20k! \\\includegraphics[width=.7\textwidth]{adv_REINFORCE}\end{center}
\end{frame}
